...
function ageClassification(n) {
  var msg='';
  msg = n>0 ? n>24 ? n>44 ? n>65 ? n>75 ? n>90 ? n>122 ? null : 'долгожители' : 'старческий возраст' : 'пожилой возраст' : 'средний возраст' : 'молодой возраст' : 'детский возраст' : null;
  return msg;
}
...
function oddFn(n) {
  ...
  while (index < n) {
    index++;
    if (index%2 === 1) oddArray.push(index);
  }
  return oddArray;
  }
...
console.log(cbRandom(10,20));
console.log(cbRandom(0,10));
console.log(cbRandom(22,32));
...
console.log(cbPow(3, 2));
console.log(cbPow(2, 3));
...
console.log(cbAdd(2, 3));
console.log(cbAdd(20, 3));
console.log(cbAdd(100, 13));
console.log(cbAdd(50, 80));
/*
